...
public class AuthController {
    ...
    static {
        ...
        users.add(new User("moderador", "12345", 1000.0, 0.0, "MODERATOR"));
        users.add(new User("admin", "admin123", 5000.0, 0.0, "ADMIN"));
        users.add(new User("teste", "teste123", 500.0, 0.0, "USER"));
    }
